...
namespace MarsQA_1.Pages
{
    public static class ProfileSkillsPage
    {
        ...
        public static void AddSkillsFromExcelSheet()
        {
            // Find Xpath for skills tab
            ...
            ExcelLibHelper.PopulateInCollection(@"C:\Saisree\Testing\Code\MarsQACode\MarsQA-1\SpecflowTests\Data\Skills.xlsx", "Skills sheet");
            ...
            for (int i = 2; i <= 2; i++)
            {
                ...
                var Skillexceldata = ExcelLibHelper.ReadData(i, "Skill");
                var Levelexceldata = ExcelLibHelper.ReadData(i, "Level");

                // find xpath for Addskill and assign input parameter skill

                Driver.driver.FindElement(By.XPath("//*[@id='account-profile-section']/div/section[2]/div/div/div/div[3]/form/div[3]/div/div[2]/div/div/div[1]/input")).SendKeys(Skillexceldata);
                ...
                // assert expected result = actual result
                Assert.AreEqual("C# has been added to your skills", alerttext);
                ...
                foreach (var elemTr in lstTrElem)
                {
                    ...
                    if (lstTdElem.Count > 0)
                    {
                        ...
                        string skillText = lstTdElem[0].Text;
                        string LevelText = lstTdElem[1].Text;
                        Assert.AreEqual(Skillexceldata, skillText);
